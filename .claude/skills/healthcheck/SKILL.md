---
name: healthcheck
description: Run the full local verification pipeline before pushing — ktlint (auto-format if needed), all unit tests, then google + fdroid debug builds. Use when the user asks to "run healthcheck", verify the branch is green, or sanity-check changes before committing/pushing.
---
