 ...
 * */
@Module
class ApplicationTestModule(private val windscribeApp: Windscribe) {
    private val logger = LoggerFactory.getLogger("di")
    ...
    fun provideServerListUpdater(
            ...
            localDbInterface: LocalDbInterface,
            preferenceChangeObserver: PreferenceChangeObserver,
            userRepository: UserRepository, appLifeCycleObserver: AppLifeCycleObserver
    ...
    fun provideWindNotificationBuilder(
        ...
        return WindNotificationBuilder(
                ...
                trafficCounter, scope, serviceInteractor
        )
    }
    ...
    fun provideWireguardBackend(
        ...
        return WireguardBackend(
                ...
                vpnConnectionStateManager,
                serviceInteractor, protocolManager, vpnProfileCreator, userRepository, deviceStateManager
        )
    }
    ...
    fun providesPrimaryApiEndpointMap(): Map<HostType, String> {
        return mapOf(Pair(HostType.API, NetworkKeyConstants.API_ENDPOINT),
                ...
                Pair(HostType.CHECK_IP, CHECK_IP_URL))
    }
