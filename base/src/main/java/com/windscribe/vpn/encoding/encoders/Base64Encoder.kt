...
class Base64Encoder : Encoder {
    ...
    protected val encodingTable = byteArrayOf(
        'A'.code.toByte(), 'B'.code.toByte(), 'C'.code.toByte(), 'D'.code.toByte(), 'E'.code.toByte(), 'F'.code.toByte(), 'G'.code.toByte(),
        'H'.code.toByte(), 'I'.code.toByte(), 'J'.code.toByte(), 'K'.code.toByte(), 'L'.code.toByte(), 'M'.code.toByte(), 'N'.code.toByte(),
        'O'.code.toByte(), 'P'.code.toByte(), 'Q'.code.toByte(), 'R'.code.toByte(), 'S'.code.toByte(), 'T'.code.toByte(), 'U'.code.toByte(),
    ...
    override fun decode(data: String, out: OutputStream): Int {
        val b1: Byte
        val b2: Byte
        val b3: Byte
        val b4: Byte
        ...
        length += decodeLastBlock(
            out, data[end - 4], data[end - 3], data[end - 2],
            data[end - 1]
        )
     ...
     */
    @Throws(IOException::class)
    override fun encode(data: ByteArray, off: Int, length: Int, out: OutputStream): Int {
