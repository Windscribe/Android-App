...
interface UpgradePresenter {
    ...
    fun buyGoogleProduct(productDetailsParams: List<BillingFlowParams.ProductDetailsParams>?)
    ...
    fun regionalPlanIfAvailable(sku: String): String?

    fun onRegionalPlanSelected(url: String)
}
