...
fun ScreenDescriptionPreview() {
    ScreenDescription(
        text =
            "R.O.B.E.R.T. is a customizable server-side domain and IP blocking tool. Select the block lists " +
                "you wish to apply on all your devices by toggling the switch. Learn more",
    )
}
