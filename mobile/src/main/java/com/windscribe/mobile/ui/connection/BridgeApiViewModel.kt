...
class BridgeApiViewModelImpl
    ...
    constructor(
            ...
            viewModelScope.launch(Dispatchers.IO) {
                ...
                withContext(Dispatchers.Main) {
                    if (result) {
                        val messageResId =
                            if (currentlyPinned) {
                                com.windscribe.vpn.R.string.ip_unpinned_successfully
                            } else {
                                com.windscribe.vpn.R.string.ip_pinned_successfully
                            }
                        ...
                        val errorMessageResId =
                            if (currentlyPinned) {
                                com.windscribe.vpn.R.string.could_not_unpin_ip
                            } else {
                                com.windscribe.vpn.R.string.could_not_pin_ip
                            }
        ...
        private suspend fun performPinIpAction(
            selectedCity: Int,
