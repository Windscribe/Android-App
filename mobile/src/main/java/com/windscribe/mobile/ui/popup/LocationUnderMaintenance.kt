...
fun LocationUnderMaintenanceScreen() {
    ...
    PopupContainer {
        ...
        PopupTitle(com.windscribe.vpn.R.string.under_maintenance)
        Spacer(Modifier.height(25.dp))
        PopupDescription(com.windscribe.vpn.R.string.check_status_description)
        Spacer(Modifier.height(32.dp))
        PopupPrimaryActionButton(modifier = Modifier, com.windscribe.vpn.R.string.check_status) {
            activity?.openUrl(NetworkKeyConstants.NODE_STATUS_URL)
            navController.popBackStack()
        }
        Spacer(modifier = Modifier.height(16.dp))
        PopupSecondaryActionButton(modifier = Modifier, com.windscribe.vpn.R.string.back) {
            navController.popBackStack()
        }
        Spacer(Modifier.weight(1f))
    }
