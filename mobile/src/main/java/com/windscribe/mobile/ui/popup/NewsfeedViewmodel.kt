        ...
        private fun createNotificationItem(notification: WindNotification): NewsfeedItem {
            ...
            if (newsfeedAction != null) {
                ...
                return NewsfeedItem(
                    ...
                    title =
                        HtmlCompat
                            .fromHtml(notification.notificationTitle, HtmlCompat.FROM_HTML_MODE_LEGACY)
                            .toString(),
                    message = htmlBody,
            ...
            if (message.contains("ncta")) {
                ...
                if (match != null) {
                    ...
                    return NewsfeedItem(
                        ...
                        title =
                            HtmlCompat
                                .fromHtml(notification.notificationTitle.uppercase(Locale.getDefault()), HtmlCompat.FROM_HTML_MODE_LEGACY)
                                .toString(),
                ...
                is Action.Newsfeed -> {
                    val pushNotificationAction =
                        PushNotificationAction(
                            ...
                            action.newsfeedAction.promoCode,
                            action.newsfeedAction.type,
                        )
