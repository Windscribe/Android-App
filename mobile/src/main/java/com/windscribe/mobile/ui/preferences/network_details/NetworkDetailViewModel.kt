            ...
            viewModelScope.launch(Dispatchers.IO) {
                ...
                localDbInterface.allNetworks
                    ...
                    .collect { networkList ->
                        ...
                        logger.debug(
                            "Found network info: ${networkInfo?.networkName}, protocol: ${networkInfo?.protocol}, port: ${networkInfo?.port}",
                        )
                        ...
                        logger.debug(
                            "VPN active: $vpnActive, auto-secure: ${networkInfo?.isAutoSecureOn}, global pref: ${preferencesHelper.globalUserConnectionPreference}",
                        )
