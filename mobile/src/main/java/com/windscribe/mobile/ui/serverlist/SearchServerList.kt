...
private fun LocationItem(
    ...
    val isLocationPremiumOnly by viewModel
    ...
    Column(
        ...
        Row(
            ...
            Text(
                ...
                color =
                    if (expanded) {
                        MaterialTheme.colorScheme.serverListSecondaryColor
                    } else {
                        MaterialTheme.colorScheme.serverListSecondaryColor
                            .copy(
                                0.70f,
...
@Composable
private fun SearchListNavigation(
    viewModel: ServerViewModel,
    homeViewmodel: HomeViewmodel,
) {
    ...
    Box(
        ...
        Row(
            ...
            Image(
                ...
                modifier =
                    Modifier.Companion.hapticClickable {
                        viewModel.toggleSearch()
                    },
