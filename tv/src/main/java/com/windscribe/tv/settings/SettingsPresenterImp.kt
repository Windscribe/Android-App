...
class SettingsPresenterImp
    ...
    constructor(
        ...
        InstalledAppsAdapter.InstalledAppListener {
        ...
        override fun onInstalledAppClick(
            updatedModel: InstalledAppsData?,
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        logger.debug(
                            "Error Submitting Log: " +
                                WindError.instance.convertThrowableToString(
                                    e,
                                ),
                        )
        ...
        override fun setupLayoutForGeneralTab() {
            ...
            settingView.setupLanguageAdapter(
                savedLanguage,
                resourceHelper.getStringArray(com.windscribe.vpn.R.array.language),
            )
        ...
        private fun getProtocolFromHeading(
            portMapResponse: PortMapResponse?,
            heading: String,
        ): String {
            portMapResponse?.let {
        ...
        private fun setExpiryOrResetDate(
            premiumUser: Boolean,
            resetOrExpiryDate: String?,
        ) {
            ...
            if (resetOrExpiryDate != null) {
                try {
                    ...
                    logger.debug(
                        "Could not parse date data. " +
                            WindError.instance.convertErrorToString(
                                e,
                            ),
                    )
                }
